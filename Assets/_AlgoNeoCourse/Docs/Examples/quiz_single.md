...
- Прогресс квизов сохраняется автоматически в локальный JSON; отдельное включение больше не требуется.
...
- Уже пройденные квизы восстанавливаются после перезапуска Unity.
