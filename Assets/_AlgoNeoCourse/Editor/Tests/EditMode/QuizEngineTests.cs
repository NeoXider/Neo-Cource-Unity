    ...
    public class QuizEngineTests
    {
        ...
        public void Single_Attempts_Respects_Max()
        {
            QuizQuestion q = new()
            {
                ...
                {
                    new() { id = "a1", text = "A", isCorrect = false },
                    new() { id = "a2", text = "B", isCorrect = true }
                }
            };
            QuizQuestionState s = new() { questionId = q.id };
        ...
        public void Multiple_Correctness_Matches_Selected()
        {
            QuizQuestion q = new()
            {
                ...
                answers = new List<QuizAnswer>
                {
                    new() { id = "a1", text = "A", isCorrect = true },
                    new() { id = "a2", text = "B", isCorrect = false },
                    new() { id = "a3", text = "C", isCorrect = true }
                }
            };
            QuizQuestionState s = new() { questionId = q.id };
        ...
        {
            QuizQuestion q1 = new() { id = "q1", kind = QuizKind.Single };
            QuizQuestion q2 = new() { id = "q2", kind = QuizKind.TrueFalse };
            LessonQuizState state = new() { lessonPath = "lesson.md" };
