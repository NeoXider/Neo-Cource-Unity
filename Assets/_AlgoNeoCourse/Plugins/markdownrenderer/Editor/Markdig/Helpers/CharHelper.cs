...
namespace Markdig.Helpers
{
    ...
    public static class CharHelper
    {
        ...
        private static readonly Dictionary<char, int> romanMap = new(6)
        {
            { 'i', 1 }, { 'v', 5 }, { 'x', 10 },
            { 'I', 1 }, { 'V', 5 }, { 'X', 10 }
        };
            ...
            out bool canClose)
        {
            ...
            bool prevIsExcepted = prevIsPunctuation && punctuationExceptions.Contains(pc);
            bool nextIsExcepted = nextIsPunctuation && punctuationExceptions.Contains(c);
        ...
        {
            return c.IsZero() || c.IsWhitespace();
        }
        ...
        public static void CheckUnicodeCategory(this char c, out bool space, out bool punctuation)
        {
            ...
            if (c <= 'ÿ')
            {
                ...
                punctuation = c == '\0' || (c >= 33 && c <= 47) || (c >= 58 && c <= 64) || (c >= 91 && c <= 96) ||
                              (c >= 123 && c <= 126);
            }
            else
            {
        ...
        internal static bool IsSpaceOrPunctuation(this char c)
        {
            if (c <= 'ÿ')
            {
                return c == '\0' || c == ' ' || (c >= '\t' && c <= '\r') || c == '\u00a0' || c == '\u0085' ||
                       (c >= 33 && c <= 47 && c != 38) || (c >= 58 && c <= 64) || (c >= 91 && c <= 96) ||
                       (c >= 123 && c <= 126);
            }
