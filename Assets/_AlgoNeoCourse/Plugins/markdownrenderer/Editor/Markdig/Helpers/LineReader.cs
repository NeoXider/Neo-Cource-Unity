    ...
    public struct LineReader
    {
        ...
        public StringSlice ReadLine()
        {
            ...
            for (int i = sourcePosition; i < text.Length; i++)
            {
                ...
                {
                    int length = 1;
                    NewLine newLine = NewLine.CarriageReturn;
                    ...
                    StringSlice slice = new(text, sourcePosition, i - length, newLine);
                    SourcePosition = i + 1;
                    return slice;
                }
                ...
                if (c == '\n')
                {
                    StringSlice slice = new(text, sourcePosition, i - 1, NewLine.LineFeed);
                    SourcePosition = i + 1;
                    return slice;
                }
            }
