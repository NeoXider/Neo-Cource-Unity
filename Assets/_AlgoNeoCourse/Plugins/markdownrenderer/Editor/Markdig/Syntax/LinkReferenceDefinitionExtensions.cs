...
namespace Markdig.Syntax
{
    ...
    public static class LinkReferenceDefinitionExtensions
    {
        ...
        public static bool ContainsLinkReferenceDefinition(this MarkdownDocument document, string label)
        {
            ...
            LinkReferenceDefinitionGroup? references = document.GetData(DocumentKey) as LinkReferenceDefinitionGroup;
        ...
        public static void SetLinkReferenceDefinition(this MarkdownDocument document, string label,
            LinkReferenceDefinition linkReferenceDefinition, bool addGroup)
        {
            if (label is null)
            {
                ThrowHelper.ArgumentNullException_label();
            ...
            LinkReferenceDefinitionGroup references = document.GetLinkReferenceDefinitions(addGroup);
        ...
        public static bool TryGetLinkReferenceDefinition(this MarkdownDocument document, string label,
            [NotNullWhen(true)] out LinkReferenceDefinition? linkReferenceDefinition)
        {
            if (label is null)
            {
                ThrowHelper.ArgumentNullException_label();
