...
namespace Markdig.Syntax
{
    ...
    public abstract class LeafBlock : Block
    {
                ...
                if (value != null)
                {
                    if (value.Parent != null)
                    {
                        ThrowHelper.ArgumentException(
                            "Cannot add this inline as it as already attached to another container (inline.Parent != null)");
                    }

                    if (value.ParentBlock != null)
                    {
                        ThrowHelper.ArgumentException(
                            "Cannot add this inline as it as already attached to another container (inline.ParentBlock != null)");
                    }
        ...
        ///     Whether to keep track of trivia such as whitespace, extra heading characters and unescaped
        ///     string values.
        /// </param>
        public void AppendLine(ref StringSlice slice, int column, int line, int sourceLinePosition, bool trackTrivia)
        {
            ...
            StringLine stringLine = new(ref slice, line, column, sourceLinePosition, slice.NewLine);
