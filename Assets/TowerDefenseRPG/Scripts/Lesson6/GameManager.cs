...
namespace TowerDefenseRPG.Lesson6
{
    public class GameManager : MonoBehaviour
    {
        ...
        public int baseHealthUpgradeCost = 8;
        ...
        public void TryBuyBaseHealthUpgrade()
        {
            if (!CanSpendCurrency(baseHealthUpgradeCost))
            {
                return;
            }

            currentCurrency -= baseHealthUpgradeCost;
            defensePoint.UpgradeMaxHealth(2);
            UpdateUI();
        }
